...
class syncerpstatus extends consumerbase {

    function exec(){
        //老ERP接口关闭
        /*
    	$t = time() - 3600 * 24 * 3;
    	$list = $this->db->query("SELECT erp_no FROM `order` o LEFT JOIN order_expand e  ON o.order_id = e.order_id AND e.erp_code in(1,2,3,4,5,6,7,17,22,25,26,8,18,27,15)  AND o.add_time > " . $t)->fetchAll();
