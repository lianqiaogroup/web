                ...
                <el-row :gutter="20">
                    ...
                    <el-col :span="8">
                        <el-form-item label="部门权限">
                            <el-input v-model="formValue.belong_id_department"></el-input>
                        </el-form-item>
                    </el-col>
                </el-row>
                <el-row :gutter="20">
                ...
                <!-- <el-row :gutter="20">
                    <el-col :span="24">
                        <el-form-item label="模版风格">
                            <el-select v-model="formValue.style" multiple placeholder="请选择模版风格">
                                <el-option
...
export default {
  ...
  mounted() {
    ...
    // 获取语种
    this.$http.get("http://cdn.bgnht.com/config/theme_language").then(res => {
    ...
    // 获取数据
    this.$http
      .post("shop_theme.php?act=edit&sid=" + this.$route.params.id || 0)
      .then(res => {
        // 地区
  ...
  methods: {
    ...
    //   formdata.style = this.formValue.style.join(",");
      this.$http
        .post("shop_theme.php?act=save", formdata, { emulateJSON: true })
        .then(res => {
          if (res.body.ret == "1") {
            this.$message({ message: "添加成功", type: "success" });
            this.$router.push({ path: "/shopthemes" });
          } else {
